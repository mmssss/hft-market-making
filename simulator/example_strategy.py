...
class Strategy:
    ...
    def __init__(self, sim: ExchangeSimulator, max_position: float,
                 order_lifetime: int, orders_delay: int,
        ...
        Args:
            ...
            orders_delay:
                Delay between placing new orders.
            enable_log:
        ...
        self.orders_delay = orders_delay
        ...
        while True:
            ...
            if type(update) == MdUpdate:
                if update.orderbook is not None:
                    ...
                    if self.current_time - last_readjust > self.orders_delay:
                        last_readjust = self.current_time
